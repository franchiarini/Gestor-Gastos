...
export default function SharedEvolutionPage() {
  ...
  return <section aria-labelledby="shared-evolution-title"><SectionHeader id="shared-evolution-title" title="Evolución" description="Seguí la evolución de los gastos mes a mes." /><ExpenseEvolution spaceId={spaceId} /></section>
}
